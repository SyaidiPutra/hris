...
class pengalamanKerja_model
{
    ...
    public function store($data)
    {
        ...
        $this->db->bind('nama_perusahaan', $data[0]['nama_perusahaan']);
        $this->db->bind('jabatan', $data[0]['jabatan']);
        $this->db->bind('dept', $data[0]['dept']);
        $this->db->bind('durasi', $data[0]['durasi']);
        $this->db->bind('alasan_berhenti', $data[0]['alasan_berhenti']);
        $this->db->bind('jobdesc', $data[0]['jobdesc']);
        $this->db->bind('gaji_terakhir', $data[0]['gaji_terakhir']);
